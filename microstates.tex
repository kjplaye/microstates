...
\title{Quantum Measurement -- Microstates and Matter Channels}
...
timelike and spacelike channels. 
...
Newton's laws. Non-thermal microstates in flat
Minkowski spacetime are
constructed as helicity-anticorrelated Bell states each producing 
an Aichelburg--Sexl pp-wave at Rindler horizons; the 
...
counts. A Carnot efficiency bound and the Unruh--Landauer 
bound are shown to be the same inequality viewed from opposite 
directions, and the Gibbons--Hawking--York term arises as the effective action for 
...
Measurement events are gravitational microstates. The argument 
...
of gravity; we provide one explicit construction, a 
helicity-anticorrelated Bell state sourced by a bilocal 
term in flat Minkowski space, and show that this single 
example satisfies all required properties event by event. 
It is a seed, not a complete theory.
...
establishes the bottom and right solid arrows. The dashed 
arrow is the Di\'{o}si--Penrose postulate, which we do not 
adopt. The asymmetry is the point.}
\label{fig:diagram}
\end{figure}
...
\section{Appendix: Regularisation of the Aichelburg--Sexl Singularity}
\label{sec:as_reg}
