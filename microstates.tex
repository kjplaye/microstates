...
\abstract{
We show how quantum measurements naturally play the role of
microstates in thermodynamic approaches to gravity
...
Rindler wedges.
In our example, proper time emerges as a property of matter,
and space as a label associated with the
entangled helicity across the horizon. We
connect the matter action, event by event, to a 
...
single physical event, a handoff between matter 
...
physical event: the handoff event deposits one quantum 
...
\begin{enumerate}
    ...
    \item \textbf{The handoff event} 
      (Section~\ref{sec:handoff}): The communication, an elementary
      massless carrier, 
...
and that crossing is the handoff event, converting 
...
handoff itself. Before the crossing $\mathcal{R}$ and 
...
The photon crossing the horizon is a handoff between 
...
A \emph{handoff event} is a horizon-crossing 
...
The handoff event of Section~\ref{sec:handoff} has a 
...
alternating rhythm of handoff events rather than the 
...
and $\mathcal{L}$, and each vertex is a handoff event 
...
between handoff events. Each vertex is a handoff event: 
...
the handoff event of Section~\ref{sec:handoff}. The Raychaudhuri 
...
along worldlines, space is the record of handoff events 
...
handoff events, matter-memory, PVM projections, the 
