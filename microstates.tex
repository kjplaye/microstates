...
\begin{enumerate}
    \item \textbf{Matter as a timelike memory} (Section~\ref{sec:channel}):
...
Let $\dot{N}$ be the interaction rate in
equation (\ref{eq:newton_rate}).
$\mathcal{R}$ is at rest and each absorbed photon 
imparts momentum $\hbar\omega/c$.
The saturation 
