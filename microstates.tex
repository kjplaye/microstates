...
%------------------------------------------------------
\subsection{The Zig-Zag Mechanism}
\label{sec:zigzag}
%------------------------------------------------------

The channel picture is not an ad hoc construction: 
the handoff event of Section~\ref{sec:handoff} is the 
Rindler-horizon version of a structure already present in 
Penrose's zig-zag interpretation of the Dirac 
equation~\cite{penrose2006road}. The zig-zag is, in 
