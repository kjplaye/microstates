...
arrow is the Di\'{o}si--Penrose postulate. Section~\ref{sec:substrate} develops the 
information-theoretic framework that connects 
all four corners into a single physical event.}
\label{fig:diagram}
\end{figure}
...
\label{sec:ppwave}
We introduce coordinates for the photon traveling from $\mathcal{P}$ $(-1,0)$ to $\mathcal{R}$ $(0,1)$ (there is a similar story for the left wedge).
We work in the null coordinates $u, v$ defined 
in Section~\ref{sec:microstates}, where the photon propagates along the null plane $u = 0$, $z$ is the longitudinal direction, and $(x,y)$ are transverse coordinates. Then $(u,v)$ = $(0,0)$ is $\mathcal{P}$'s location, $(u,v)$ = $(0,2)$ is $\mathcal{R}$'s location, and $(u,v)$ = $(0,1)$ is the intersection of the photon with the past right Rindler horizon.
...
% Section 9
\section{Appendix A: Carnot Cycle from Unruh--Landauer}
\label{sec:carnot}
...
% Section 11
\section{Appendix C: Consistency of the Double-Null Gauge Condition}
...
% Section 12
\section{Appendix D: Regularisation of the Aichelburg--Sexl Singularity}
\label{sec:as_reg}
...
% Section 13
\section{Appendix E: Observer-Relativity and the Multi-Observer Problem}
