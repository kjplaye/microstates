...
A structuring choice runs throughout the paper. We work in the non-thermal 
...
spectrum. The area increment $\Delta A = 8\pi G\hbar\omega$ and the event-by-event equality 
...
event: in the delocalized limit the full thermofield 
double produces a global BMS supertranslation displacing 
both wedges uniformly, while in the localized limit each 
individual measurement event produces a single AS 
longitudinal shift concentrated near the photon 
...
intellectual debt is real and the author is glad to 
