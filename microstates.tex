...
% TODO A: Normalize British --> American spelling
...
measurement of a classical bit, a reinterpretation of the
ER=EPR correspondence space built explicitly 
...
\subsection{ER = EPR and emergent space}
...
Maldacena and Susskind, but we opperate in flat Minkowski space
and don't use the full Ads/CFT machinery. The ER=EPR correspondence is the
ambient mathematical structure within which the bilocal construction operates. 
...
The ER side is replaced with the pair of correlated AS longitudinal shifts in 
