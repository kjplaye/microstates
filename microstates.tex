...
Whether $C$ is saturated at the event horizon of a black 
hole, where the Landauer and Bremermann limits are expected 
to coincide, is left to future work.

Recent experimental demonstrations of the Compton clock~\cite{lan2013clock} 
...
a bit that now encodes converts a polarization
state to a location in space.
