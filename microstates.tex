...
The heuristic arguments of this section are not 
presented as derivations of the standard results,
those results are well established, but as 
a first demonstration that the Unruh--Landauer 
language is consistent with them, recovering 
correct answers from the new vocabulary without 
additional assumptions. The construction layer 
of Sections~\ref{sec:microstates}--\ref{sec:ppwave} 
then shows the same consistency holds 
microstate by microstate, which is the 
new content.
...
open question with physical consequences: different 
resolutions imply different answers to whether 
...
world. In the gravitational context---with causally 
...
I am grateful to Claude for useful discussions.
