...
the connection with a simple example.
...
information transfer. This allows us to construct
and study a helicity-anticorrelated Bell 
state in flat Minkowski space in the causal Rindler
past which drives the Unruh response in the left and right
Rindler wedges. We briefly dicuss how 
proper time might be measured as a property of matter,
and then connect the matter action, event by event, to a 
Gibbons--Hawking--York boundary term and a horizon area increment.
Space is measured along the horizons by pp-wave
cut and paste and a concrete label associated with the
entangled helicity is observed across the horizon. 
}
...
$\mathcal{F}$,  each hold partial records of the same 
