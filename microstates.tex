...
\end{equation}
%
with flat weight $\phi$. Specifying $\mathcal{P} = (-1,0)$ 
...
recovering the full thermal plane wave; $\sigma \to 0$ gives 
a sharp PVM projector onto the $\mathcal{P}$--$\mathcal{R}$ 
null geodesic, recovering the localized non-thermal 
microstate. The Stokes phenomenon of~\cite{player2025driving}, 
