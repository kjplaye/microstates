...
physical event: a communication event deposits one quantum 
of action into matter-memory, records one classical bit, 
and imprints one Planck-area patch onto the horizon, 
all simultaneously. The Planck area $\ell_P^2$ is the 
conversion factor between the geometric and 
...
The matter substrate gives rise to a channel 
