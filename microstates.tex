...
\begin{conjecture}
  $C$ is saturated at the event horizon of a black hole.
\end{conjecture}

In bridging the macroscopic precision of the Compton clock with the rapid microscopic dynamics of Schrödinger’s Zitterbewegung motion \cite{schrodinger1930kraftefreie}, modern physics continues to validate De Broglie’s foundational insight \cite{de1924recherches} that a particle's rest mass is, at its core, an intrinsic quantum clock.
Recent experimental demonstrations of the Compton
clock \cite{lan2013clock} ground some of these speculations.
...
the same identity at the level of individual microstates: each 
contribution to $S_{GHY}$ corresponds to one quantum of action 
deposited into matter-memory by one measurement event, precisely 
the communications of Section~\ref{sec:horizon_channel}. The Raychaudhuri 
equation and the communication definition count the same events 
