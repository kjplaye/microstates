...
\end{definition}
Note that both quantities are extensive under composition:
\begin{equation}
    \frac{mc^2}{\hbar} 
...
The communications interactions of Section~\ref{sec:horizon_channel}
has a natural analogue along a timelike worldline. Penrose's 
