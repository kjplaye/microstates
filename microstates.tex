...
and make the identification explicit by developing an
...
Minkowski space, makes simultaneous contact with Jacobson's thermodynamic
...
we provide one explicit construction, measurements of a
...
Thermality is not a property of any single microstate but of 
the ensemble; it emerges when one models the detector response 
within a wedge as a sum over all Rindler modes, as in the 
standard Unruh--DeWitt treatment~\cite{unruh1976notes, 
einstein1979general}, and is a consequence of that 
mode-averaging rather than a premise of the construction. 
The bilocal source eliminates this coarse-graining by 
selecting a definite frequency $\omega$, fixing both the 
observer location and the spatial origin of the detected 
excitations~\cite{player2025driving}.
...
The bilocal source excites a single Unruh mode at 
definite Rindler frequency $\omega$: from 
$\mathcal{R}$'s perspective this is a Rindler plane 
wave at $\omega$ rather than a thermal superposition 
over frequencies, while from $\mathcal{P}$'s 
Minkowski perspective the same mode is spread across 
Minkowski frequencies through the red/blue shift of 
the Rindler geometry. 
