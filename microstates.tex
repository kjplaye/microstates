...
Using a pp-wave cut-and-paste surgery, we show how space is dynamically advanced along the horizons. This newly generated geometry carries a concrete label tied to the entangled helicity, which is subsequently observed across the causal horizon, allowing for the measurement of space simultaneously in geometric and informational terms.
}
...
photon sources an AS pp-wave at the Rindler horizon, 
...
We develop a language that will provide a way of thinking about our microstate as a building block for emergent spacetime. We discuss matter action $S_{\mathrm{matter}}$ as quantized proper time; $\mathcal{P}$ and $\mathcal{R}$ are massive observers that accumulate this action. Our microstate transfers a portion of this action across the horizon, a communication, which we
study as the Gibbons--Hawking--York boundary term in the next Section \ref{sec:microstate_action}. Then we find that a bit of space, $\mathcal{R}$ vs. $\mathcal{L}$, emerges naturally in Section \ref{sec:erepr}. In this way, space and time can be measured as properties of matter and interactions. Our language is going to be that of classic information theory, channels.
...
by each AS pp-wave at the Rindler horizon is a supertranslation 
