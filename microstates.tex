...
Explicit microstates are constructed as helicity-anticorrelated 
Bell states of photons sourced by a bilocal driving term; each 
produces an Aichelburg--Sexl pp-wave at the Rindler horizon, and 
the Raychaudhuri equation yields the event-by-event consistency 
check $S_{GHY}|_{\mathcal{H}} = S_{\mathrm{matter}}$: geometric 
and informational counts of the same measurement events, with the 
Planck area $\ell_P^2$ as the conversion factor. The Carnot 
efficiency bound and the Unruh--Landauer bound are shown to be 
the same inequality viewed from opposite directions, and the GHY 
term arises as the effective action for one Rindler wedge after 
integrating out the other.}
