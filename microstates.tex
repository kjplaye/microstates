...
$\mathcal{R}$ (right wedge). This is a \emph{spatial 
bit}: a bit that now encodes not a polarization state but 
a location in space.
...
have to be written. Space, in this construction, is a 
consequence of helicity. We leave it there.
