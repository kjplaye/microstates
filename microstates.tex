...
\abstract{
We identify the microscopic carriers of individual entropy 
increments in thermodynamic approaches to gravity as quantum 
measurement events. Eliminating temperature between Landauer's 
principle and the Unruh effect yields a single 
acceleration-dependent bound on the energy cost of information 
acquisition, from which the Schwarzschild radius, surface 
gravity, and Bekenstein--Hawking area law follow via Newton's 
second law alone. We construct explicit microstates realizing 
individual terms of the Unruh thermal ensemble as 
helicity-anticorrelated Bell states of photons, sourced by a 
bilocal driving term in the Rindler setting. Each microstate 
produces an Aichelburg--Sexl pp-wave at the Rindler horizon; 
applying the Raychaudhuri equation to the resulting null 
