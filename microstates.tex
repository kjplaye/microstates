...
The subsequent derivations are explicitly 
Verlinde-style heuristics~\cite{entropic}: the same 
actors appear, acceleration, the Unruh relation, 
Newton's laws, but thermality is eliminated rather 
than embraced. Where Verlinde deploys the thermal 
Rindler frame as the mechanism connecting entropy 
to force, the Unruh--Landauer relation of 
Section~\ref{sec:UL} eliminates temperature 
entirely, and Newton's laws then recover standard 
black hole thermodynamics directly from the 
resulting kinematic bound. Thermality is a 
consequence of restricted causal access to one 
Rindler wedge~\cite{fulling1973nonuniqueness, 
bisognano1975duality}, not a primitive.
...
\end{equation}
%
The direction of information flow, acquisition, erasure, 
or transmission, does not change this threshold. 
