...
form equation~\eqref{eq:UL} has not appeared previously.
...
One conceptual question the construction raises but does 
not resolve deserves explicit acknowledgment. The 
microstate events identified here are observer-relative 
in the same sense as quantum state reduction: a given 
measurement event is a microstate for the Rindler 
observer who performs it, but may be invisible to a 
different observer with a different causal horizon. The 
Bekenstein--Hawking area is objective and 
observer-independent; the present paper provides 
observer-relative microstates that sum to the correct 
area increment for a fixed Rindler observer, but does 
not establish that different observers' counts agree, 
nor that the construction is Lorentz covariant at the 
microstate level. We conjecture that a covariant 
formulation exists in which the microstate count is 
independent of the choice of Rindler frame --- 
consistent with the objectivity of the horizon area --- 
and that this formulation will make contact with the 
modular Hamiltonian approach of Bisognano and 
Wichmann~\cite{bisognano1975duality}, in which the 
Rindler Hamiltonian is canonically fixed by the modular 
flow independently of the observer. We leave this for 
future work.

\subsection*{Conceptual Position and Contrast with 
Di\'osi--Penrose}
