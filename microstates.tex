...
communications through horizons, and the Planck area $\ell_P^2$ 
...
\begin{enumerate}
    ...
    \item \textbf{Communications} 
      (Section~\ref{sec:communication}): The communication;
      an elementary massless carrier, transfers action and
      information between matter-memories.
\end{enumerate}
...
\begin{quote}
\textbf{Definition (Communication).}\ 
A \emph{communication} is a horizon-crossing 
...
substrates as communications, while massive systems 
...
The communications of Section~\ref{sec:communication} has a 
...
the communications of Section~\ref{sec:communication}. The Raychaudhuri 
