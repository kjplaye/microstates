...
grounding for the present construction; in each, 
the missing physical process is quantum 
measurement, which does not appear explicitly 
in any of them. Jacobson~\cite{jacobson1995thermodynamics} derives the Einstein 
...
locations of $\mathcal{P}$ and $\mathcal{R}$ breaks this 
...
frequency $\omega$, a PVM projection onto a definite helicity 
outcome resolves the frequency coarse-graining: after the 
collapse there is no $\omega$-averaging and no 
partial-trace ambiguity, and the observer is at a specific 
point in microstate space within the non-thermal Minkowski 
description. In this sense measurement is access to the 
...
The rainbow coloring shows the Rindler mode frequency structure 
across the wedge. A PVM projection onto this null line selects 
